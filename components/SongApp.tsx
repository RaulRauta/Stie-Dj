...
export default function SongApp() {
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#050208] px-5 text-white">
        <div className="text-center">
          <p className="text-xs font-black uppercase tracking-[0.4em] text-fuchsia-300">
            Live Music Voting
          </p>
  ...
  if (!votingOpen) {
    return (
      <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050208] px-5 text-white">
        ...
        <div className="absolute left-[30%] top-[20%] h-[260px] w-[260px] rounded-full bg-blue-700/10 blur-3xl" />

        <section className="relative z-10 mx-auto max-w-xl rounded-[2.25rem] border border-white/10 bg-white/[0.06] p-7 text-center shadow-2xl backdrop-blur-xl">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-3xl border border-purple-400/20 bg-purple-500/10 text-3xl shadow-[0_0_35px_rgba(168,85,247,0.25)]">
            ♪
          </div>

          <p className="mb-4 text-xs font-black uppercase tracking-[0.35em] text-purple-300/90">
            Live Music Voting
          </p>

          <h1 className="text-4xl font-black leading-[0.95] tracking-[-0.04em] text-white/95 md:text-5xl">
            Pregătim votul
          </h1>
          ...
          <div className="mx-auto mt-8 inline-flex rounded-full border border-purple-500/20 bg-purple-500/10 px-5 py-2 text-sm font-black text-purple-200">
            În așteptare
          </div>
        </section>
      </main>
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#050208] px-4 py-6 text-white md:px-6 md:py-10">
      <div className="absolute left-[-150px] top-[-150px] h-[420px] w-[420px] rounded-full bg-purple-700/35 blur-3xl" />
      <div className="absolute right-[-170px] top-[180px] h-[420px] w-[420px] rounded-full bg-fuchsia-700/25 blur-3xl" />
      <div className="absolute bottom-[5%] left-[25%] h-[320px] w-[320px] rounded-full bg-blue-700/10 blur-3xl" />

      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.07),transparent_35%),linear-gradient(to_bottom,rgba(168,85,247,0.08),transparent_45%)]" />

      <div className="relative z-10 mx-auto max-w-6xl">
        <section className="mb-6 overflow-hidden rounded-[2.25rem] border border-white/10 bg-white/[0.055] p-5 text-center shadow-2xl backdrop-blur-xl md:p-8">
          <div className="mx-auto mb-5 inline-flex rounded-full border border-purple-500/20 bg-purple-500/10 px-4 py-2 text-xs font-black uppercase tracking-[0.25em] text-purple-200 shadow-[0_0_25px_rgba(168,85,247,0.12)]">
            Live Music Voting
          </div>

          <h1 className="mx-auto max-w-3xl text-4xl font-black leading-[0.9] tracking-[-0.06em] text-white/95 md:text-7xl">
        ...
        <section className="grid gap-5 lg:grid-cols-[0.85fr_1.15fr]">
          <form
            onSubmit={addSong}
            className="rounded-[2.25rem] border border-white/10 bg-white/[0.06] p-5 shadow-2xl backdrop-blur-xl md:p-6"
          >
            <div className="mb-5">
              <p className="text-xs font-black uppercase tracking-[0.22em] text-purple-300/90">
                Intră în joc
              </p>
              <h2 className="mt-2 text-3xl font-black tracking-[-0.045em] text-white/95">
                Caută piesa ta
              </h2>
            </div>
            ...
            <div className="relative mb-3" ref={suggestionRef}>
              <input
                ...
                disabled={hasVoted}
                className="w-full rounded-2xl border border-white/10 bg-black/45 px-4 py-4 text-base font-semibold text-white/90 outline-none transition placeholder:text-zinc-600 focus:border-purple-500 disabled:cursor-default disabled:opacity-60"
              />
              ...
              {filteredSongs.length > 0 && (
                <div className="absolute left-0 right-0 top-full z-50 mt-2 max-h-72 overflow-y-auto rounded-2xl border border-white/10 bg-zinc-950 shadow-2xl">
                  {filteredSongs.map((song) => (
                    ...
                    >
                      <div>
                        <p className="font-black tracking-[-0.02em] text-white/90">
                          {song.title}
                        </p>
                      ...
                      <span className="shrink-0 rounded-full border border-purple-500/20 bg-purple-500/10 px-3 py-1 text-sm font-black text-purple-200">
          ...
          <section className="rounded-[2.25rem] border border-white/10 bg-white/[0.045] p-5 shadow-2xl backdrop-blur-xl md:p-6">
            <div className="mb-5 flex items-center justify-between gap-4">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.22em] text-purple-300/90">
                  Live
                </p>
                <h2 className="mt-1 text-3xl font-black tracking-[-0.045em] text-white/95">
                  Topul serii
                </h2>
              </div>

              <span className="rounded-full border border-purple-500/20 bg-purple-500/10 px-4 py-2 text-sm font-black text-purple-200">
                Top live
              </span>
            </div>
            ...
            {leader && (
              <div
                className={`mb-4 overflow-hidden rounded-[2rem] border p-5 transition-all duration-300 ${
              ...
              >
                <div className="mb-5 flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                  <div className="min-w-0">
                    <div className="mb-4 inline-flex rounded-full border border-purple-400/20 bg-purple-500/10 px-3 py-1 text-[11px] font-black uppercase tracking-[0.24em] text-purple-200/90">
                      În frunte acum
                    </div>

                    <h3 className="break-words text-4xl font-black leading-[0.95] tracking-[-0.055em] text-white/95 md:text-5xl">
                      {leader.title}
                    </h3>

                    <p className="mt-2 break-words text-base font-semibold text-zinc-300/80">
                      {leader.artist}
                    </p>

                    {votedSongId === leader.id && (
                      <div className="mt-4 inline-flex rounded-full border border-purple-400/30 bg-purple-500/10 px-3 py-1 text-xs font-black text-purple-100">
                        Alegerea ta
                      </div>
                    )}
                  </div>

                  <div className="w-full shrink-0 rounded-3xl border border-purple-400/25 bg-black/35 px-4 py-4 text-center shadow-[0_0_24px_rgba(168,85,247,0.12)] sm:w-28">
                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-purple-200/70">
                      Voturi
                    </p>
                    <p className="mt-1 text-5xl font-black leading-none tracking-[-0.06em] text-white/95">
                      {leader.votes}
                    </p>
                    <p className="mt-1 text-[11px] font-black text-purple-200/70">
                ...
                <button
                  ...
                  className="w-full rounded-2xl border border-purple-400/20 bg-purple-500/20 px-5 py-3 font-black text-purple-50 transition-all duration-300 hover:scale-[1.01] hover:bg-purple-500/30 hover:shadow-[0_0_28px_rgba(168,85,247,0.28)] disabled:cursor-default disabled:opacity-45 disabled:hover:scale-100 disabled:hover:shadow-none"
                >
                  {voteButtonText}
                </button>
              </div>
                ...
                >
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      {votedSongId === song.id && (
                        <div className="mt-2 inline-flex rounded-full border border-purple-400/30 bg-purple-500/10 px-2.5 py-1 text-xs font-black text-purple-100">
                          Alegerea ta
                        </div>
                      )}
                    </div>
                  ...
                  <div className="shrink-0 text-right">
                    <button
                      ...
                      className="rounded-full border border-purple-400/20 bg-purple-500/10 px-4 py-2 text-sm font-black text-purple-100 transition-all duration-300 hover:bg-purple-500/20 disabled:cursor-default disabled:opacity-40"
                    >
                      {voteButtonText}
                    </button>

                    <div className="mt-2 text-xs font-black text-purple-300/80">
                      {song.votes} {song.votes === 1 ? "vot" : "voturi"}
                    </div>
                  </div>
                </div>
